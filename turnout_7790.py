...
cat = ["HUFINAL", "HETENURE", "HETELHHD", "HRHTYPE", "HUBUS", "GEREG", "GESTCEN", "GTCBSAST", "PEMARITL", "PESEX", "PEEDUCA", "PTDTRACE", "PRPERTYP", "PRCITSHP", "PRDTIND1", "PRMJIND1", "PRMJOCC1", "PRMJOCGR", "PENLFJH", "PENLFACT", "PRCHLD"]
num = ["HUFAMINC", "HRNUMHOU", "GTCBSASZ", "PEAGE", "PEAFEVER", "PEHSPNON", "PRINUSYR", "PEMJNUM", "PEHRUSL1", "PRNAGPWS", "PEERNUOT", "PEERNLAB", "PESCHFT", "PESCHLVL", "PRNMCHLD", "PEDIPGED", "PECYC", "PEGRPROF"]
inputLabels = cat + num
